...
abstract contract Setup is CurtaSolution(1, 22) {
    // -------------------------------------------------------------------------
    // Immutable storage
    // -------------------------------------------------------------------------
    ...
    function setUp() public virtual override {
        ...
        puzzle = IPuzzle(0x7a1079F083D73971F568A3Cd888E687f173e0047);
        vm.label(address(puzzle), "Puzzle #22: Stake Frens");

        // Add puzzle to Curta as `mockAuthor`.
        vm.prank(mockAuthor);
        curta.addPuzzle(puzzle, 22);
    }
}
