...
abstract contract Setup is CurtaSolution(1, 14) {
    // -------------------------------------------------------------------------
    // Immutable storage
    // -------------------------------------------------------------------------
    ...
    function setUp() public virtual override {
        ...
        puzzle = IPuzzle(HuffDeployer.deploy("curta/eth/14/SacredGeometry"));
        vm.label(address(puzzle), "Puzzle #14: Sacred Geometry");

        // Add puzzle to Curta as `mockAuthor`.
        vm.prank(mockAuthor);
        curta.addPuzzle(puzzle, 14);
    }
}
