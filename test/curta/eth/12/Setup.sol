...
abstract contract Setup is CurtaSolution(1, 12) {
    // -------------------------------------------------------------------------
    // Immutable storage
    // -------------------------------------------------------------------------
    ...
    function setUp() public virtual override {
        ...
        puzzle = IPuzzle(HuffDeployer.deploy("curta/eth/12/Labyrinth"));
        vm.label(address(puzzle), "Puzzle #12: Labyrinth");

        // Add puzzle to Curta as `mockAuthor`.
        vm.prank(mockAuthor);
        curta.addPuzzle(puzzle, 12);
    }
}
